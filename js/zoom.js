...
(function(global, factory) {
  ...
  var isSupported = function isSupported(node) {
    return node.tagName === "IMG" || node.tagName === 'VIDEO';
  };
  ...
  var mediumZoom = function mediumZoom(selector) {
    ...
    var open = function open() {
      ...
      return new Promise(function(resolve) {
        ...
        if (active.original.parentElement && (active.original.parentElement.tagName === "PICTURE" || active.original.tagName === "VIDEO") && active.original.currentSrc) {
		...
		active.original.dispatchEvent(createCustomEvent("medium-zoom:openAfter", {
			detail: {
			  zoom: zoom,
